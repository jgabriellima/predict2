 ...
 * @author FADESP
 */
public class RedeMLPextend {
    double CoefiAprendH, CoefiAprendO; double[][] Train,CV;
    int NumPadroes,NumEpocas; String MelhorRede;
    Neuron[] C1,C2,C3; Peso P1,P2;
    /** Creates a new instance of RedeMLP */
    public RedeMLPextend(int NIn,int NHide,int NOut,int NPadroes, int NEpocas, double CAprendH, double CAprendO) {
    ...
    public RedeMLPextend(String Nomearq){
        String linha = null;
        try{
    ...
    */
    ...
    public void SalvaRede(String Nomerede){
      ...
      try{  
         ...
         String linhasaida="";
         saida.println("# Pesos da Rede Treinada");
    ...
    public void Treinamento(){
        ...
        for(int epocas=0;epocas<NumEpocas;epocas++){
            ...
            if(ErroMSEmenor>ErroMSE){
               ...
               System.out.println("Época = "+epocas+" ErroMSECV = "+ErroMSE);
               NomeRede="temp/rede_"+epocas+"_"+ErroMSEmenor+".txt";
       ...
       try{ 
       FileWriter writer = new FileWriter(new File("MSEtest.txt"));
       PrintWriter saida = new PrintWriter(writer);  
       String linhasaida="";
