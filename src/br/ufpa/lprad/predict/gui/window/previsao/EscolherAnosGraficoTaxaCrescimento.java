 ...
 * @author jgabriellima
 */
public class EscolherAnosGraficoTaxaCrescimento extends javax.swing.JInternalFrame {
    ...
    public EscolherAnosGraficoTaxaCrescimento() {
        initComponents();
        init();
    }

    public EscolherAnosGraficoTaxaCrescimento(String tituloGrafico, String tituloEixoX,
    ...
    private void initComponents() {
        ...
        panelAnosPrevisao.setLayout(new java.awt.GridLayout());
