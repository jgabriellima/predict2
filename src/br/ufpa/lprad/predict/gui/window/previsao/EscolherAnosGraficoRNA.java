...
import br.ufpa.lprad.predict.previsao.neural.grafico.ModeloGraficoRNA;
 ...
 * @author jgabriellima
 */
public class EscolherAnosGraficoRNA extends javax.swing.JInternalFrame {
    ...
    public EscolherAnosGraficoRNA() {
        initComponents();
        init();
    }

    public EscolherAnosGraficoRNA(String tituloGrafico, String tituloEixoX,
